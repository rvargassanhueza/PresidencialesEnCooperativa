...
public class Autentication extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
        ...
        firebaseAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    Toast.makeText(Autentication.this, "Create Account Success", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(Autentication.this, "Create Account Unsuccess", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void  signIn(String email, String password){
        firebaseAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    Toast.makeText(Autentication.this, "Authentication Success", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(Autentication.this, ContainerActivity.class);
                    startActivity(i);
                    finish();
                }else {
                    Toast.makeText(Autentication.this, "Authentication Unsuccess", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void signInGoogleFirebase(GoogleSignInResult googleSignInResult){
        if (googleSignInResult.isSuccess()){
            ...
            firebaseAuth.signInWithCredential(authCredential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()){
                        Toast.makeText(Autentication.this, "Google Authentication Success", Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(Autentication.this, ContainerActivity.class);
                        startActivity(i);
                        finish();
                    }else {
                        Toast.makeText(Autentication.this, "Google Authentication Unsuccess", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }else {
            Toast.makeText(Autentication.this, "Google Sign In Unsuccess", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void signInFacebookFirebase(AccessToken accessToken){
        ...
        firebaseAuth.signInWithCredential(authCredential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    Toast.makeText(Autentication.this, "Facebook Authentication Success", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(Autentication.this, ContainerActivity.class);
                    startActivity(i);
                    finish();
                }else{
                    Toast.makeText(Autentication.this, "Facebook Authentication Unsuccess", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
